...
public class RecycleForPublic extends RecyclerView.Adapter<RecycleForPublic.ViewHolder>  {
    ...
    public RecycleForPublic(ArrayList<PubAndSocia> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public RecycleForPublic.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        CardView view = (CardView) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_pub_social,viewGroup,false);
        return new RecycleForPublic.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder,final int i) {
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myRef = database.getReference("users/public/"+list.get(i).getUserid());
                myRef.removeValue();
            }
        });
